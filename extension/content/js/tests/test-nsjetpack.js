var WrapperTests = {
  testWrapperWorks: function(self) {
    var global = new Object();
    this._xpcshellTests.call(global, false);
  },

  _xpcshellTests: function(doOutput) {
    function output(msg) {
      if (doOutput)
        dump(msg + "\n");
    }
...
if (!this.window) {
  // We're running in xpcshell, so just execute the tests now.
  WrapperTests._xpcshellTests.call(this, true);
}
